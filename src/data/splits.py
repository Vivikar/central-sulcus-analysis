...
via11_splits = {'train': ['sub-via374', 'sub-via234', 'sub-via213', 'sub-via118',
                          'sub-via276', 'sub-via279', 'sub-via088', 'sub-via320',
                          'sub-via368', 'sub-via378', 'sub-via453', 'sub-via378',
                          'sub-via209', 'sub-via390', 'sub-via344', 'sub-via407',
                          'sub-via348', 'sub-via452', 'sub-via390', 'sub-via390',
                          'sub-via052', 'sub-via515', 'sub-via435', 'sub-via481',
                          'sub-via201', 'sub-via400', 'sub-via377', 'sub-via442',
                          'sub-via253', 'sub-via171', 'sub-via348', 'sub-via142',
                          'sub-via146', 'sub-via509', 'sub-via372', 'sub-via374',
                          'sub-via201', 'sub-via052', 'sub-via004', 'sub-via320',
                          'sub-via141', 'sub-via141', 'sub-via481', 'sub-via391',
                          'sub-via142', 'sub-via101', 'sub-via294', 'sub-via372',
                          'sub-via072', 'sub-via443', 'sub-via088', 'sub-via488',
                          'sub-via126', 'sub-via456', 'sub-via253', 'sub-via399',
                          'sub-via294', 'sub-via509', 'sub-via372', 'sub-via452',
                          'sub-via390', 'sub-via387', 'sub-via400', 'sub-via379',
                          'sub-via319', 'sub-via378', 'sub-via522', 'sub-via435',
                          'sub-via387', 'sub-via152', 'sub-via435', 'sub-via410',
                          'sub-via429', 'sub-via350', 'sub-via101', 'sub-via387',
                          'sub-via452', 'sub-via385', 'sub-via023', 'sub-via101'],
                'validation': ['sub-via153', 'sub-via277', 'sub-via323', 'sub-via467',
                               'sub-via402', 'sub-via499', 'sub-via185', 'sub-via489',
                               'sub-via173', 'sub-via020', 'sub-via483', 'sub-via486',
                               'sub-via206', 'sub-via401', 'sub-via269', 'sub-via326',
                               'sub-via354', 'sub-via343', 'sub-via438', 'sub-via215',
                               'sub-via504', 'sub-via517', 'sub-via125', 'sub-via205',
                               'sub-via389', 'sub-via289', 'sub-via151', 'sub-via108',
                               'sub-via109', 'sub-via212', 'sub-via328', 'sub-via408',
                               'sub-via124', 'sub-via325', 'sub-via083', 'sub-via273',
                               'sub-via130', 'sub-via364', 'sub-via149', 'sub-via513',
                               'sub-via085', 'sub-via444', 'sub-via150', 'sub-via069',
                               'sub-via186', 'sub-via393', 'sub-via217', 'sub-via070',
                               'sub-via478']}