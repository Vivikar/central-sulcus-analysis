...
def close_holes(vs: np.ndarray, fs: np.ndarray, hole_len_thr: float = 1000000.) -> np.ndarray:
    """
...
if __name__ == '__main__':
    vs, fs = igl.read_triangle_mesh("/mnt/projects/VIA_Vlad/nobackup/BrainVisa/BrainVisa/CFIN/sub-via248/t1mri/default_acquisition/default_analysis/folds/3.1/default_session_best/segmentation/RSulci_sub-via248_default_session_best.ply")
    # triangulation
    ...
    igl.write_triangle_mesh("data/CS_hole_filling.ply", out_vs, out_fs)
    
    res_mesh = o3d.io.read_triangle_mesh("data/CS_hole_filling.ply")
